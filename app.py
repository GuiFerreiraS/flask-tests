...
def create_app(db_url=None):
    ...
    app.config["OPENAPI_SWAGGER_UI_CONFIG"] = "https://cdn.jsdelivr.net/npm/swagger-ui-dist/"
    ...
    def revoked_token_callback(jwt_header, jwt_payback):
        return (
            jsonify({"message": "The token has revoked.",
                    "error": "token_revoked"}),
            401
        )

    @jwt.needs_fresh_token_loader
    def token_not_frash_callback(jwt_header, jwt_payback):
        return (
    ...
    def expired_token_callback(jwt_header, jwt_payback):
        return (
